...
import com.example.cowinreportservice.testingunit.models.ErrorDetails;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDetails> handleMaxSizeException(MaxUploadSizeExceededException exception,
                                    WebRequest webRequest) {
